...
- **Релей:** ближе к пользователю (часто РФ / тот же ДЦ), стабильный маршрут до зарубежного VPN.
...
| **E + D** | Обычно **не** смешивают: D уже даёт вход через мост РФ; E — другой паттерн (чистый L4) |
