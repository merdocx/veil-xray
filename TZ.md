...
> **Примечание:** Это исторический документ с первоначальным техническим заданием проекта. Большинство требований реализовано. Актуальную информацию о проекте см. в [README.md](README.md) и [CHANGELOG.md](CHANGELOG.md).
